...
|--------------------------------------------------------------------------
|
| APP_LOCALE y APP_FALLBACK_LOCALE son 'es'. Sin este archivo Laravel no
| tiene de dónde traducir y responde la clave cruda ("validation.required").
|
*/
...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'El campo :attribute apareció en una filtración de datos. Elige otro distinto.',
    ],
    ...
    'uploaded' => 'Subir el campo :attribute falló.',
    'url' => 'El campo :attribute debe ser una URL válida.',

    'custom' => [
        'usuario' => [
            'unique' => 'Ya existe una cuenta registrada con ese usuario.',
        ],
        'nombre' => [
    ...
    // Evita que el usuario lea "nombre_completo" dentro de un mensaje.
    'attributes' => [
