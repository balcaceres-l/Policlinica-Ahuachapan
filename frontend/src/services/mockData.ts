...
/**
 * Horarios de atención por médico (HU-34). El horario base de la policlínica
 * es 3:00–6:30 PM entre semana y 8:00–12:00 MD los sábados; dermatología
 * (médico 3) atiende por la mañana y pediatría (médico 4) parte el sábado en
 * dos bloques, que es justamente el caso que la validación debe permitir.
 */
